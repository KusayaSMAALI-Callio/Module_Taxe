tableextension 8062614 "CAGTX_Sales Line" extends "Sales Line"
{
    fields
    {
        ...
        {
            BlankZero = true;
            CalcFormula = Sum("CAGTX_Sales Doc. Tax Detail"."Amount Tax Line" WHERE("Document Type" = FIELD("Document Type"),
