table 8062637 "CAGTX_Item Tax"
{
    ...
    ObsoleteReason = 'Field Length Error in a field that is included in Primary Key.';
    ...
    local procedure CheckCalculType(p_Rec: Record "CAGTX_Item Tax")
    var
