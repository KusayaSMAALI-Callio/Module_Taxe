table 8062641 "CAGTX_Purch. Doc. Tax Detail"
{

    DrillDownPageID = "CAGTX_Purch. Doc. Tax Detail";
    LookupPageID = "CAGTX_Purch. Doc. Tax Detail";
    ...
    fields
    {
        ...
        field(18; "Qty. to Receive"; Decimal)
        {
            ...
            CalcFormula = Lookup("Purchase Line"."Qty. to Receive" WHERE("Document Type" = FIELD("Document Type"),
                                                                          "Document No." = FIELD("Document No."),
                                                                          "Line No." = FIELD("Line No.")));
        ...
        {
            CalcFormula = Lookup("Purchase Line"."Line Discount %" WHERE("Document Type" = FIELD("Document Type"),
                                                                          "Document No." = FIELD("Document No."),
                                                                          "Line No." = FIELD("Line No.")));
        ...
        field(28; "Line Discount Amount"; Decimal)
        {
            ...
            AutoFormatType = 1;
            CalcFormula = Lookup("Purchase Line"."Line Discount Amount" WHERE("Document Type" = FIELD("Document Type"),
                                                                               "Document No." = FIELD("Document No."),
                                                                               "Line No." = FIELD("Line No.")));
        ...
        field(30; "Amount Including VAT"; Decimal)
        {
            AutoFormatExpression = "Currency Code";
            AutoFormatType = 1;
            CalcFormula = Lookup("Purchase Line"."Amount Including VAT" WHERE("Document Type" = FIELD("Document Type"),
                                                                               "Document No." = FIELD("Document No."),
                                                                               "Line No." = FIELD("Line No.")));
        ...
        field(69; "Inv. Discount Amount"; Decimal)
        {
            AutoFormatExpression = "Currency Code";
            AutoFormatType = 1;
            CalcFormula = Lookup("Purchase Line"."Inv. Discount Amount" WHERE("Document Type" = FIELD("Document Type"),
                                                                               "Document No." = FIELD("Document No."),
                                                                               "Line No." = FIELD("Line No.")));
        ...
        {
            CalcFormula = Lookup("Purchase Line"."Currency Code" WHERE("Document Type" = FIELD("Document Type"),
                                                                        "Document No." = FIELD("Document No."),
                                                                        "Line No." = FIELD("Line No.")));
        ...
        field(8062655; "Tax Type"; Enum "Purchase Line Type")
        {
